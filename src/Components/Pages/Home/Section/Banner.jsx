   ...
   <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
     <div className="grid max-w-md grid-cols-1 mx-auto lg:grid-cols-12 gap-x-6 gap-y-8 lg:max-w-none">
       <div className="self-center lg:col-span-4">
         <h1 className="text-3xl font-bold text-gray-900 sm:text-4xl xl:text-5xl">Hey 👋 I am Reday Islam, Web Analycis.</h1>
         ...
         <div className="relative inline-flex mt-9 group">
           ...
           <a
             download={'Hridoy islam Resume.txt'}
             href='./public/Hridoy islam Resume.txt'
             title=""
             ...
             role="button"
           >
             Download My Resume by Click here
           </a>
         </div>
       </div>

       <div className="self-end lg:order-last lg:pb-20 lg:col-span-3">
         <p className="text-xs font-bold tracking-widest text-gray-500 uppercase">⚡️ Latest Projects</p>

         <div className="mt-6 space-y-6 lg:space-y-8">
           <div className="relative overflow-hidden">
             <div className="flex items-start lg:items-center">
               <img className="object-cover w-12 h-12 rounded-lg shrink-0" src="https://i.ibb.co/QKhsgjy/384788254-205139155924419-7566296408766308266-n-removebg-preview.png" alt="" />
               <p className="ml-5 text-base font-bold leading-6 text-gray-900">
                 <a href="#" title="">
                   How to rank a website within 1 month
       ...
       <div className="self-end lg:col-span-5">
         <img className="w-full mx-auto" src="https://i.ibb.co/QKhsgjy/384788254-205139155924419-7566296408766308266-n-removebg-preview.png" alt="" />
       </div>
     </div>
   </div>
 </section>
