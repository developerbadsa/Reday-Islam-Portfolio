...
export function StickyNavbar() {
 ...
 return (
  <div className=" max-h-[768px] w-[calc(100%+48px)] overflow-scroll">
   <Navbar className="sticky top-0 z-10 h-max bg-blue-500 max-w-full rounded-none px-4 py-2 lg:px-8 lg:py-4">
     ...
     <div className="flex items-center gap-4">
      ...
      <div className="flex items-center gap-x-1">
       ...
       <Button
        variant="filled"
        size="sm"
        className="hidden lg:inline-block rounded-lg text-white"
       >
        <span>Sign in</span>
       </Button>
      </div>
